...
INTEGRATION_DEFINITIONS: tuple[IntegrationDefinition, ...] = (
    ...
    IntegrationDefinition(
        ...
        setup_hint="Set XAI_API_KEY and optionally XAI_MODEL (default: grok-3). Base URL: https://api.x.ai/v1.",
        fields=(
            _field("XAI_API_KEY", "API Key", "xAI API key from console.x.ai.", secret=True, required=True),
            _field("XAI_MODEL", "Default Model", "Model to use (e.g. grok-3, grok-3-mini)."),
        ),
        env_all=("XAI_API_KEY",),
