...
const initialState = {
  ...
  // Views & panels
  activeView: "files",
  // files | git | orchestration | settings
  sidebarOpen: true,
  chatOpen: true,
  terminalOpen: false,
  // Editor tabs
...
function AppProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContext.Provider, { value: { state, dispatch, openFile }, children });
}
function useApp() {
  ...
  const run = async (cmd) => {
    ...
    switch (cmd.id) {
      ...
      case "view-files":
        ...
        break;
      case "view-git":
        dispatch({ type: "SET_VIEW", view: "git" });
        break;
      case "view-agents":
        dispatch({ type: "SET_VIEW", view: "orchestration" });
        break;
      case "view-models":
...
function FileExplorer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-explorer", onClick: () => contextMenu && closeCtx(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "explorer-toolbar", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "icon-btn", title: "Refresh", onClick: loadRoot, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshIcon$1, {}) }),
    ...
    async function init2() {
      ...
      try {
        const { Terminal } = await __vitePreload(async () => {
          const { Terminal: Terminal2 } = await import("./xterm-Z4N16yYD.js").then((n2) => n2.x);
          return { Terminal: Terminal2 };
        }, true ? [] : void 0, import.meta.url);
        const { FitAddon } = await __vitePreload(async () => {
          const { FitAddon: FitAddon2 } = await import("./addon-fit-BLjJT-gF.js").then((n2) => n2.a);
          return { FitAddon: FitAddon2 };
        }, true ? [] : void 0, import.meta.url);
        const { WebLinksAddon } = await __vitePreload(async () => {
          const { WebLinksAddon: WebLinksAddon2 } = await import("./addon-web-links-B3h9kKbr.js").then((n2) => n2.a);
...
function AIComposer({ editorInstanceRef }) {
  ...
  const [modelInventory, setModelInventory] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    const loadInventory = async () => {
      try {
        ...
        if (!cancelled) setModelInventory(data || null);
      } catch (_2) {
      }
    };
    loadInventory();
  ...
  }, [apiBase, app.backendStatus, app.selectedModel]);
  reactExports.useEffect(() => {
  ...
  }, [apiBase, chatId, app.projectRoot, app.selectedModel]);
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ac-input-footer", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: streaming ? /* @__PURE__ */ jsxRuntimeExports.jsx(StopIcon$1, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(SendIcon$1, {})
              }
            )
          ] })
        ] })
...
function MCPPanel() {
  ...
  const getServerId = (srv) => srv != null && srv.id ? srv.id : (srv == null ? void 0 : srv.server_id) || "";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-root", children: [
    ...
    showAdd && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-add-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "pp-input", rows: 10, placeholder: `{
  "mcpServers": {
...
}`, value: configJson, onChange: (e) => setConfigJson(e.target.value), style: { width: "100%", resize: "vertical", minHeight: 200 } }),
...
function SkillsPanel() {
  ...
  const load = reactExports.useCallback(async () => {
    try {
      ...
      if (!r2.ok) throw new Error(r2.statusText);
      const data = await r2.json();
      setSkills(Array.isArray(data) ? data : data.skills || data.items || []);
    } catch (e) {
      setErr(e.message);
    } finally {
      setLoading(false);
  ...
  const toggleSkill = async (agentName, current) => {
    setToggling(agentName);
    try {
      const endpoint = current ? `${base}/api/skills/${agentName}/disable` : `${base}/api/skills/${agentName}/enable`;
  ...
  const filtered = skills.filter((s) => {
    ...
    if (filter === "needs_config" && !s.needs_config) return false;
    if (search.trim()) {
      const q2 = search.toLowerCase();
      return (s.display_name || s.agent_name || "").toLowerCase().includes(q2) || (s.description || "").toLowerCase().includes(q2) || (s.category || "").toLowerCase().includes(q2);
    }
    return true;
  });
  ...
  const needsCfgCount = skills.filter((s) => s.needs_config).length;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-root", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-topbar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-topbar-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-page-title", children: "Skills" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-page-sub", children: "Manage agent skills and intent routing" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-topbar-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pp-badge pp-badge--ok", children: [
          activeCount,
          " active"
        ] }),
        needsCfgCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pp-badge pp-badge--warn", children: [
          needsCfgCount,
          " need config"
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-filters", children: [
      ...
      [
        ...
        "button",
        {
          className: `pp-tab ${filter === val ? "active" : ""}`,
          style: { padding: "5px 12px", borderBottom: "none", borderRadius: 6, border: `1px solid ${filter === val ? "var(--accent)" : "var(--border)"}` },
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-loading", children: "Loading skills…" }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-empty", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-empty-icon", children: "⚡" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-empty-title", children: "No skills found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-empty-sub", children: "Skills are auto-loaded from agent definitions. Configure your agents to expose skills." })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-skills-body", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-cat-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-cat-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-cat-name", children: cat }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-cat-count", children: grouped[cat].length })
      ] }),
      grouped[cat].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        SkillRow,
        {
          skill,
          toggling: toggling === skill.agent_name,
          onToggle: () => toggleSkill(skill.agent_name, skill.is_active)
        },
        skill.agent_name
      ))
    ] }, cat)) })
...
function SkillRow({ skill, toggling, onToggle }) {
  const intents = (() => {
    try {
      const v2 = skill.intent_patterns;
      if (Array.isArray(v2)) return v2;
      if (typeof v2 === "string") return JSON.parse(v2);
      return [];
    } catch {
      return [];
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-skill-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `pp-skill-status ${skill.is_active ? "pp-skill-status--active" : "pp-skill-status--inactive"}` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-skill-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-skill-top", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-skill-name", children: skill.display_name || skill.agent_name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `pp-badge ${skill.is_active ? "pp-badge--ok" : "pp-badge--muted"}`, children: skill.is_active ? "active" : "inactive" }),
        skill.needs_config && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-badge pp-badge--warn", children: "needs config" })
      ] }),
      skill.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-skill-desc", children: skill.description }),
      skill.needs_config && skill.missing_vars?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-skill-miss", children: [
        "⚠ Missing: ",
        skill.missing_vars.join(", ")
      ] }),
      intents.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pp-skill-intents", children: [
        intents.slice(0, 6).map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-intent-chip", children: p2 }, i)),
        intents.length > 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pp-intent-chip", children: [
          "+",
          intents.length - 6
        ] })
      ] }),
      activeWhen.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-skill-meta-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pp-skill-agent", title: "Active when", children: [
        "Active when: ",
        activeWhen.join(", ")
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-skill-meta-row", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pp-skill-agent", children: skill.agent_name }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pp-skill-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: `pp-action-btn ${skill.is_active ? "pp-action-btn--on" : ""}`,
        title: skill.is_active ? "Disable skill" : "Enable skill",
        onClick: onToggle,
        disabled: toggling,
        children: toggling ? "…" : skill.is_active ? "●" : "○"
      }
    ) })
  ] });
}
function ModelManager() {
  ...
  const pullModel = async () => {
    ...
    try {
      ...
      if (r2.ok && data.ok) {
        setPullStatus({ ok: true, msg: `✓ ${model} pulled successfully` });
        setPullTag("");
        fetchModels();
      } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-manager", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-pull-row", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-accent", disabled: pulling || !pullTag.trim(), onClick: pullModel, children: pulling ? "Pulling…" : "Pull" })
    ] }),
    pulling && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-pull-progress", children: [
      "Downloading ",
      pullTag,
    ...
    ollamaModels.length === 0 && !pulling && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-empty", children: "No Ollama models found. Pull one above or start Ollama." }),
    ollamaModels.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "model-item", children: [
...
function Settings() {
  ...
  const [skills, setSkills] = reactExports.useState([]);
  const [mcpServers, setMcp] = reactExports.useState([]);
  const [loadingSkills, setLoadingSkills] = reactExports.useState(false);
  const [loadingMcp, setLoadingMcp] = reactExports.useState(false);
  const api = window.kendrAPI;
  ...
  reactExports.useEffect(() => {
    ...
    fetch(`${apiBase}/api/skills`).then((r2) => r2.ok ? r2.json() : { skills: [] }).then((d) => setSkills(d.skills || [])).catch(() => {
    }).finally(() => setLoadingSkills(false));
  }, [tab, apiBase]);
  reactExports.useEffect(() => {
    if (tab !== "mcp") return;
    setLoadingMcp(true);
    fetch(`${apiBase}/api/mcp/servers`).then((r2) => r2.ok ? r2.json() : { servers: [] }).then((d) => setMcp(d.servers || [])).catch(() => {
  ...
  const toggleSkill = async (skillName, agentName, currentlyEnabled) => {
    const action = currentlyEnabled ? "disable" : "enable";
    try {
      await fetch(`${apiBase}/api/skills/${agentName}/${action}`, { method: "POST" });
      setSkills((prev) => prev.map(
        (sk2) => sk2.name === skillName ? { ...sk2, enabled: !currentlyEnabled } : sk2
      ));
    } catch {
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-root", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-tabs", children: TABS.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-body", children: [
      ...
      tab === "skills" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-info-banner", children: "Skills route intents to specific agents. Toggle them to control which agents handle requests." }),
        loadingSkills && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-loading", children: "Loading skills…" }),
        !loadingSkills && skills.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-empty", children: "No skills found. Make sure the backend is running." }),
        !loadingSkills && skills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-skills-list", children: skills.map((sk2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `st-skill ${sk2.enabled ? "enabled" : "disabled"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-skill-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `st-skill-dot ${sk2.enabled ? "on" : "off"}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-skill-info", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-skill-name", children: sk2.name }),
              sk2.agent && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "st-skill-agent", children: [
                "→ ",
                sk2.agent
              ] }),
              sk2.description && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-skill-desc", children: sk2.description }),
              sk2.intent_patterns?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-skill-intents", children: (Array.isArray(sk2.intent_patterns) ? sk2.intent_patterns : JSON.parse(sk2.intent_patterns || "[]")).slice(0, 4).map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-intent-chip", children: p2 }, i)) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              className: `st-toggle ${sk2.enabled ? "on" : ""}`,
              onClick: () => toggleSkill(sk2.name, sk2.agent, sk2.enabled),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-toggle-thumb" })
            }
          )
        ] }, sk2.name)) })
      ] }),
      tab === "mcp" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-info-banner", children: "Model Context Protocol (MCP) servers expose tools and resources to kendr agents." }),
        loadingMcp && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-loading", children: "Loading MCP servers…" }),
        !loadingMcp && mcpServers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-empty", children: "No MCP servers configured. Add one via Extensions → MCP Servers." }),
        !loadingMcp && mcpServers.map((srv) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-mcp-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-mcp-hdr", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `st-mcp-dot ${srv.status === "connected" ? "ok" : srv.status === "error" ? "err" : "idle"}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-mcp-name", children: srv.name || srv.id }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-mcp-status", children: srv.status || "unknown" })
          ] }),
          srv.url && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-mcp-url", children: srv.url }),
          srv.tools?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "st-mcp-tools", children: [
            srv.tools.slice(0, 6).map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "st-mcp-tool", children: t2.name || t2 }, t2.name || t2)),
            srv.tools.length > 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "st-mcp-tool st-mcp-tool--more", children: [
              "+",
              srv.tools.length - 6,
              " more"
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, { title: "Add MCP Server", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Name", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "st-input", value: s.newMcpName || "", onChange: (e) => update("newMcpName", e.target.value), placeholder: "my-mcp" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "URL / Command", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "st-input", value: s.newMcpUrl || "", onChange: (e) => update("newMcpUrl", e.target.value), placeholder: "http://localhost:8000 or npx mcp-server" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Transport", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "st-select", value: s.newMcpTransport || "http", onChange: (e) => update("newMcpTransport", e.target.value), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "http", children: "HTTP / SSE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "stdio", children: "stdio (subprocess)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ws", children: "WebSocket" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "st-actions", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "st-btn-accent", onClick: async () => {
            try {
              await fetch(`${apiBase}/api/mcp/servers`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ name: s.newMcpName, url: s.newMcpUrl, transport: s.newMcpTransport || "http" })
              });
              update("newMcpName", "");
              update("newMcpUrl", "");
              const r2 = await fetch(`${apiBase}/api/mcp/servers`);
              const d = await r2.json();
              setMcp(d.servers || []);
            } catch {
            }
          }, children: "Connect Server" }) })
        ] })
      ] }),
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Model Manager", action: () => {
          dispatch({ type: "SET_VIEW", view: "models" });
          dispatch({ type: "SET_SIDEBAR", open: true });
        } },
        { label: "Model Docs", action: () => {
          dispatch({ type: "SET_VIEW", view: "docs" });
          dispatch({ type: "SET_SIDEBAR", open: true });
        } },
        { sep: true },
...
function buildPayload(text, chatId, runId, projectRoot, mode, dr, attachments = [], studioMode = false) {
...
function ChatPanel({ fullWidth = false, hideHeader = false, studioMode = false }) {
  ...
  const [chat, dispatch] = reactExports.useReducer(chatReducer, initChat);
  const [input, setInput] = reactExports.useState("");
  const [resumeInput, setResumeInput] = reactExports.useState("");
  const [chatId] = reactExports.useState(() => `chat-${Date.now()}`);
  ...
  }, [apiBase, appState.backendStatus, appState.selectedModel]);
  const send = reactExports.useCallback(async (text, isResume = false) => {
    ...
    dispatch({ type: "ADD_MSG", msg: { id: userMsgId, role: "user", content: msg, ts: /* @__PURE__ */ new Date() } });
    dispatch({ type: "SET_STREAMING", val: true });
    dispatch({ type: "SET_RUN", id: runId });
    dispatch({ type: "CLEAR_AWAITING" });
    dispatch({
      type: "ADD_MSG",
      msg: { id: asstMsgId, role: "assistant", content: "", steps: [], status: "thinking", runId: isSimpleStudioChat ? null : runId, ts: /* @__PURE__ */ new Date() }
    });
    ...
    try {
      ...
      const body = isResume && chat.awaitingContext ? {
        ...
        reply: msg,
        channel: "webchat"
      } : buildPayload(msg, chatId, runId, appState.projectRoot, chat.mode, dr, attachments, studioMode);
  ...
  }, [input, chat.streaming, chat.awaitingContext, chat.mode, apiBase, appState.projectRoot, appState.selectedModel, chatId, dr, attachments, studioMode, isSimpleStudioChat, appDispatch]);
  const openStream = reactExports.useCallback((runId, asstMsgId) => {
    ...
    es.onerror = () => {
      dispatch({ type: "UPD_MSG", id: asstMsgId, patch: { status: chat.messages.find((m2) => m2.id === asstMsgId)?.content ? "done" : "error" } });
      es.close();
      dispatch({ type: "SET_STREAMING", val: false });
      appDispatch({ type: "SET_STREAMING", streaming: false });
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `kc-panel${fullWidth ? " kc-panel--full" : ""}`, children: [
    !hideHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-header-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "kc-icon-btn", title: "Clear chat", onClick: () => dispatch({ type: "CLEAR" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClearIcon, {}) }),
    ...
    chat.awaitingContext && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-awaiting", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-awaiting-label", children: [
        "⏳ ",
        chat.awaitingContext.prompt?.slice(0, 120)
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-awaiting-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            ...
            onKeyDown: (e) => {
              if (e.key === "Enter" && (e.ctrlKey || e.metaKey)) send(resumeInput, true);
            },
            rows: 2
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "kc-send-btn", onClick: () => send(resumeInput, true), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SendIcon, {}) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-input-area", children: [
      studioMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-attach-bar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-attach-actions", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "kc-attach-btn", onClick: attachFolder, children: "+ Folder" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-input-row", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: chat.streaming ? /* @__PURE__ */ jsxRuntimeExports.jsx(StopIcon, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(SendIcon, {})
          }
        )
      ] })
    ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-row kc-row--assistant", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-bubble kc-bubble--assistant", children: [
      msg.runId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-run-hero", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `kc-run-badge kc-run-badge--${msg.status || "thinking"}`, children: msg.status || "thinking" })
      ] }),
      ...
      msg.content && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "kc-content", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownRenderer, { content: msg.content }),
        msg.status !== "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "kc-copy-btn", onClick: copy, children: copied ? "✓" : "⧉" })
      ] }),
...
function StudioLayout() {
  ...
  const [ollamaModels, setOllama] = reactExports.useState([]);
  const [ollamaLoading, setLoading] = reactExports.useState(false);
  const [ollamaError, setError] = reactExports.useState(false);
  const [modelInventory, setModelInventory] = reactExports.useState(null);
  const [modelInventoryLoading, setModelInventoryLoading] = reactExports.useState(false);
  const [modelInventoryError, setModelInventoryError] = reactExports.useState(false);
  const apiBase = state.backendUrl || "http://127.0.0.1:2151";
  const isOnline = state.backendStatus === "running";
  const providerStatuses = Object.fromEntries(
    (modelInventory && Array.isArray(modelInventory.providers) ? modelInventory.providers : []).map((provider) => [provider.provider, provider])
  );
  const fetchModelInventory = reactExports.useCallback(() => {
    setModelInventoryLoading(true);
    setModelInventoryError(false);
    fetch(`${apiBase}/api/models`).then((r2) => r2.ok ? r2.json() : Promise.reject()).then((d) => {
      setModelInventory(d);
      setModelInventoryLoading(false);
    }).catch(() => {
      setModelInventory(null);
      setModelInventoryError(true);
      setModelInventoryLoading(false);
    });
  }, [apiBase]);
  ...
  const fetchOllama = reactExports.useCallback(() => {
    setLoading(true);
    setError(false);
    fetch(`${apiBase}/api/models/ollama`).then((r2) => r2.ok ? r2.json() : Promise.reject()).then((d) => {
      setOllama(d.models || []);
      setLoading(false);
    }).catch(() => {
      setError(true);
  ...
  reactExports.useEffect(() => {
    ...
    fetchOllama();
  }, [fetchOllama, state.backendStatus]);
  reactExports.useEffect(() => {
    if (state.backendStatus !== "running" && state.backendStatus !== "connecting") return;
    fetchModelInventory();
  }, [fetchModelInventory, state.backendStatus]);
  const selectModel = (id2) => dispatch({ type: "SET_MODEL", model: id2 });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-root", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-sidebar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-sidebar-top", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-new-chat", onClick: () => setChatKey((k2) => k2 + 1), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PlusIcon, {}),
          " New chat"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sl-conv-label", children: "Session" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-conv-item active", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChatDotIcon, {}),
          " Current chat"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sl-section-divider" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sl-conv-label", children: "CLOUD PROVIDERS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sl-providers", children: PROVIDER_ORDER.map((p2) => {
          const ui2 = getProviderUiState(p2);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              className: `sl-provider-row ${ui2.kind}`,
              onClick: () => navigate("settings"),
              title: ui2.title,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `mp-provider-dot ${p2}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-provider-name", children: PROVIDER_META[p2].label }),
                ui2.kind === "checking" && /* @__PURE__ */ jsxRuntimeExports.jsx(SpinnerIcon, { className: "sl-provider-spinner" }),
                ui2.kind === "ok" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-provider-ok", children: "✓" }),
                ui2.kind === "missing" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-provider-add", children: "+ key" }),
                ui2.kind === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-provider-error", children: "!" })
              ]
            },
            p2
          );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sl-section-divider" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-ollama-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-conv-label", style: { margin: 0 }, children: "LOCAL MODELS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshIcon, { spinning: ollamaLoading })
            }
          )
        ] }),
        ollamaLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-ollama-inline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-ollama-dot checking" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Checking…" })
        ] }),
        !ollamaLoading && ollamaError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-ollama-inline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-ollama-dot offline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ollama offline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "sl-ollama-action", onClick: fetchOllama, children: "retry" })
        ] }),
        !ollamaLoading && !ollamaError && ollamaModels.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-ollama-inline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-ollama-dot empty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "No local models" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "sl-ollama-action", onClick: () => navigate("models"), children: "pull →" })
        ] }),
        !ollamaLoading && ollamaModels.map((m2) => {
          const id2 = `ollama/${m2.name || m2}`;
          const name = m2.name || m2;
          const isActive = state.selectedModel === id2;
          const sizeGB = m2.size ? (m2.size / 1e9).toFixed(1) : null;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              className: `sl-model-btn ${isActive ? "active" : ""}`,
              onClick: () => selectModel(isActive ? null : id2),
              title: `${name}${sizeGB ? ` — ${sizeGB} GB` : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-model-dot" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-model-name", children: name }),
                sizeGB && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "sl-model-size", children: [
                  sizeGB,
                  " GB"
                ] }),
                isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-model-check", children: "✓" })
              ]
            },
            id2
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-sidebar-bottom", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-nav-btn", onClick: () => navigate("runs"), title: "Runs & Orchestration", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RunsNavIcon, {}),
          " Runs"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-nav-btn", onClick: () => navigate("agents"), title: "Agents & Capabilities", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AgentsNavIcon, {}),
          " Agents"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-nav-btn", onClick: () => navigate("mcp"), title: "MCP Servers", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MCPNavIcon, {}),
          " MCP"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-nav-btn", onClick: () => navigate("models"), title: "Model Manager", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ModelsNavIcon, {}),
          " Models"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "sl-nav-btn", onClick: () => navigate("settings"), title: "Settings", children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mp-dropdown", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mp-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mp-group-label mp-group-label--row", children: [
          ...
          "Local (Ollama)",
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mp-refresh-btn", onClick: onRefreshOllama, title: "Refresh Ollama models", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshIcon, {}) })
        ] }),
...
function SpinnerIcon({ className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      strokeWidth: "2.2",
      strokeLinecap: "round",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 12a9 9 0 1 1-3.2-6.9" })
    }
  );
}
...
function App() {
  const { state, dispatch } = useApp();
  const v2 = state.activeView;
  const isStudio = state.appMode === "studio";
  const isConfigView = CONFIG_VIEWS.includes(v2);
  reactExports.useEffect(() => {
    const handler = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-root", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar", style: { WebkitAppRegion: "drag" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-icon", style: { WebkitAppRegion: "no-drag" }, children: "K" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MenuBar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ModeSwitch, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-center", style: { WebkitAppRegion: "drag" }, children: !isStudio && state.projectRoot && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "titlebar-project", children: state.projectRoot.split(/[\\/]/).pop() }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "titlebar-spacer" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-body", children: [
      isStudio && !isConfigView && /* @__PURE__ */ jsxRuntimeExports.jsx(StudioLayout, {}),
      isStudio && isConfigView && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "full-view", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sl-back-bar", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "sl-back-btn", onClick: () => dispatch({ type: "SET_VIEW", view: "chat" }), children: "← Back to Studio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sl-back-title", children: CONFIG_TITLES[v2] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigPanelContent, { v: v2 })
      ] }),
      !isStudio && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dv-root", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectWorkspace, {}),
        isConfigView && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dv-overlay", onClick: (e) => {
          if (e.target === e.currentTarget) closeOverlay();
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dv-panel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dv-panel-hdr", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dv-panel-title", children: CONFIG_TITLES[v2] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "dv-panel-close", onClick: closeOverlay, title: "Close (Esc)", children: "✕" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dv-panel-body", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ConfigPanelContent, { v: v2 }) })
        ] }) })
      ] })
    ] }),
...
function ConfigPanelContent({ v: v2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    v2 === "agents" && /* @__PURE__ */ jsxRuntimeExports.jsx(AgentsPanel, {}),
    v2 === "mcp" && /* @__PURE__ */ jsxRuntimeExports.jsx(MCPPanel, {}),
    v2 === "skills" && /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsPanel, {}),
    v2 === "runs" && /* @__PURE__ */ jsxRuntimeExports.jsx(AgentOrchestration, {}),
    v2 === "models" && /* @__PURE__ */ jsxRuntimeExports.jsx(FullPageWrap, { title: "Model Manager", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModelManager, {}) }),
    v2 === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(FullPageWrap, { title: "Settings", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {}) }),
    v2 === "docs" && /* @__PURE__ */ jsxRuntimeExports.jsx(FullPageWrap, { title: "Model Docs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModelDocs, {}) })
  ] });
}
function ModeSwitch() {
  const { state, dispatch } = useApp();
...
function FullPageWrap({ title, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fp-wrap", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fp-header", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fp-body", children })
  ] });
}
